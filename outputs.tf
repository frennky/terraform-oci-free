...
output "compartment-name" {
  ...
  value       = oci_identity_compartment.free_tier_compartment.name
}
...
output "instance-name" {
  ...
  value       = oci_core_instance.free_tier_instance.display_name
}

output "instance-region" {
  description = "The region that contains the availability domain the instance is running in."
  value       = oci_core_instance.free_tier_instance.region
}
...
output "instance-shape" {
  ...
  value       = oci_core_instance.free_tier_instance.shape
}

output "instance-state" {
  description = "The current state of the instance."
  value       = oci_core_instance.free_tier_instance.state
}
